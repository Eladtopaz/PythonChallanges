...
# Hint - One small letter, surrounded by three big bodyguards on each of its sides.
# Open the source code to find this mess:
...
while i < len(mess):
    ...
    # need to be - small big big big small big big big small
    if mess[i] in abc and mess[i+1] in ABC and mess[i+2] in ABC and mess[i+3] in ABC:
        if mess[i+4] in abc and mess[i+5] in ABC and mess[i+6] in ABC and mess[i+7] in ABC and mess[i+8] in abc:
            my_string += mess[i+4]
    i += 1
print(my_string)


# Solution: linkedlist. URL: http://www.pythonchallenge.com/pc/def/linkedlist.html

# Next hint - linkedlist.php. URL: http://www.pythonchallenge.com/pc/def/linkedlist.php